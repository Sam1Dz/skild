...
export default function SkillCard({ skill }: { skill: Skill }) {
	return (
		<Link to="/">
			<article className="group flex cursor-pointer flex-col justify-between overflow-hidden rounded-3xl border border-border bg-surface transition-all duration-200 hover:-translate-y-0.5 hover:border-accent hover:shadow-xl">
				<div>
